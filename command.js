...
Command.prototype = {
    GET: function (handler, query, status) {
        ...
        if (handler instanceof String || typeof handler === 'string') {
            ...
            return this.action(function (args, callback) {
                GET(RESTline, this, handler, query, status);
                callback();
            });
        }
        ...
        return this.action(function (args, callback) {
            var action = this;
            handler.apply(this, [
                args, /*GET:*/ function (path, query, status) {
                    GET(RESTline, action, path, query, status);
                }
            ]);
            callback();
        });
    ...
    POST: function (handler, query, data, status) {
        ...
        if (handler instanceof String || typeof handler === 'string') {
            ...
            return this.action(function (args, callback) {
                POST(RESTline, this, handler, query, data, status);
                callback();
            });
        }
        // ==> handler is a function for processing volpal command args
        ...
        return this.action(function (args, callback) {
            var action = this;
            handler.apply(this, [
                args, /*POST:*/ function (path, query, data, status) {
                    POST(RESTline, action, path, query, data, status);
                }
            ]);
            callback();
        });
